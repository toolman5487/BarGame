//
//  GameSettingStatisticsCell.swift
//  BarGame
//
...
@MainActor
final class GameSettingStatisticsCell: DetailBaseCollectionViewCell {
    ...
    private let winsView = GameSettingStatisticsMetricView(
        systemName: "trophy.fill",
        tintColor: .systemYellow
    )
    private let completedGamesView = GameSettingStatisticsMetricView(title: "場次")
    private let lossesView = GameSettingStatisticsMetricView(
        systemName: "flag.fill",
        tintColor: .label
    )
    private let winRateView = GameSettingStatisticsMetricView(title: "勝率")
    private let averagePointsView = GameSettingStatisticsMetricView(title: "平均點數")
    private let streakView = GameSettingStatisticsMetricView(title: "近況")
    ...
    func configure(state: GameSettingStatisticsState) {
        apply(state: state)
    }
    ...
    private func apply(state: GameSettingStatisticsState) {
        switch state {
        case .loading:
...
@MainActor
private final class GameSettingStatisticsMetricView: UIView {
