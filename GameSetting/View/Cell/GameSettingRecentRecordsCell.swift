//
//  GameSettingRecentRecordsCell.swift
//  BarGame
//
...
@MainActor
final class GameSettingRecentRecordsEmptyView: BaseHintView {
...
@MainActor
final class GameSettingRecentRecordsErrorView: BaseHintView {
...
@MainActor
final class GameSettingRecentRecordsCell: DetailBaseCollectionViewCell {
    ...
    enum Metrics {
        ...
        static func preferredHeight(
            for state: GameSettingRecentRecordsState
        ) -> CGFloat {
            switch state {
            case .content:
    ...
    private let emptyView = GameSettingRecentRecordsEmptyView()
    private let errorView = GameSettingRecentRecordsErrorView()
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(GameSettingRecentRecordItemCell.self)
        return collectionView
    }()

    // MARK: - State

    private var records: [GameSettingRecentRecord] = []
    ...
    func configure(state: GameSettingRecentRecordsState) {
        apply(state: state)
    }
    ...
    private func apply(state: GameSettingRecentRecordsState) {
        switch state {
        case .loading:
            records = []
        ...
        case .content(let records):
            self.records = Array(records.prefix(GameSettingRecentRecordsState.maximumRecordCount))
...
extension GameSettingRecentRecordsCell: UICollectionViewDataSource {
    ...
    func collectionView(
        ...
        let cell = collectionView.dequeueReusableCell(
            GameSettingRecentRecordItemCell.self,
            for: indexPath
        )
...
@MainActor
final class GameSettingRecentRecordItemCell: DetailBaseCollectionViewCell {
    ...
    func configure(record: GameSettingRecentRecord) {
