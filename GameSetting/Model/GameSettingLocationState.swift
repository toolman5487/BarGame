//
//  GameSettingLocationState.swift
//  BarGame
//
...
nonisolated enum GameSettingLocationState: Equatable, Sendable {
    ...
    var presentation: GameSettingLocationPresentation {
        switch self {
        case .notRequested:
            return GameSettingLocationPresentation(
                title: "尚未取得地點",
...
nonisolated struct GameSettingLocationPresentation: Equatable, Sendable {
