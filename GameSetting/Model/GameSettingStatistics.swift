...
nonisolated struct GameSettingStatistics: Equatable, Sendable {
...
nonisolated enum GameSettingStatisticsState: Equatable, Sendable {

    case loading
    case empty
    case content(GameSettingStatistics)
    ...
    init(statistics: GameStatistics) {
        ...
        self = .content(GameSettingStatistics(statistics: statistics))
    }
}
