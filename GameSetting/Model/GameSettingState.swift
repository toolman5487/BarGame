...
nonisolated struct GameSettingState: Equatable, Sendable {

    let sections: [GameSettingSection]
    ...
    func applying(_ change: GameSettingChange) -> GameSettingState {
        GameSettingState(
            sections: sections.map { section in
                switch section {
                case .rules:
    ...
    func updatingLocationState(
        _ locationState: GameSettingLocationState
    ) -> GameSettingState {
        GameSettingState(
            sections: sections.map { section in
                switch section {
