...
@MainActor
class StandardBaseTitleHeader: UICollectionReusableView {
...
extension UICollectionView {
    ...
    func register(_ headerType: StandardBaseTitleHeader.Type) {
        register(
            headerType,
    ...
    func dequeueReusableHeader<Header: StandardBaseTitleHeader>(
